class Project < ActiveRecord::Base
  ...
  has_attached_file :image6, url: "/projects/:handle/:basename_:style.:extension", styles: { thumbnail: "100x100>", regular: "300x300>" }
  ...
  [:image1, :image2, :image3, :image4, :image5, :image6].each do |image|
    validates_attachment image, content_type: { content_type: ["image/jpg", "image/gif", "image/png"] }
  end
  #Create image delete methods
  [:image1, :image2, :image3, :image4, :image5, :image6, :source_download].each do |attachment|
